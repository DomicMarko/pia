 ...
 */
public class FestivalAdd  implements java.io.Serializable {
    ...
    public FestivalAdd(String naziv, Date datumVremeOd, Date datumVremeDo, String mesto, String status, Double prosecnaOcena, String info, Integer maxRezUser, Integer brojPregleda, Double cenaPaket, Double cenaDan, Set rezervacijas, Set izvodjacs, Set links, Set ocenas, Set medias, Set porukas, Set komentars, Set dans) {
       this.naziv = naziv;
    ...
    public int getNumOfDaysFestival() {
        return numOfDaysFestival;
    }

    public void setNumOfDaysFestival(int numOfDaysFestival) {
        this.numOfDaysFestival = numOfDaysFestival;
    }        
